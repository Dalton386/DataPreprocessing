...
write.table(as.list(c("ID", patients)), "./results/MutexInput/data_Mutex.txt",sep="\t", col.names = FALSE, row.names=FALSE, quote = FALSE)
write.table(results, "./results/MutexInput/data_Mutex.txt", append = TRUE, sep="\t", col.names = FALSE, row.names=TRUE, quote = FALSE)
